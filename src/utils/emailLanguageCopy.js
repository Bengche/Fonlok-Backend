...
const COPY = {
  en: {
    ...
    invoicePaid: {
      subject: (invoiceNumber) => `✅ Invoice Paid — Please Deliver | Invoice ${invoiceNumber} | Fonlok`,
      ...
      nextStep2: "Use the chat to keep the buyer updated and share proof of delivery.",
      nextStep3: "Once the buyer confirms receipt, Fonlok will release your funds immediately.",
    ...
    paymentConfirmed: {
      subject: (invoiceNumber) => `Payment Confirmed - Invoice ${invoiceNumber} | Fonlok`,
      simpleTitle: "Payment Confirmed",
      simpleBody: "Your payment has been received successfully. Your funds are held securely in escrow and will only be released to the seller once you confirm delivery.",
      ...
      milestoneNote: "The seller will work through each milestone. Once a milestone is marked complete, you will receive a <strong>separate email with a secure one-click release link</strong> for that milestone only. No funds are ever moved without your explicit confirmation.",
      ...
      step2: "You receive an email with a secure, one-time release link for that milestone only.",
      step3: "Click the link to review and confirm &mdash; funds are never released without your explicit approval.",
      step4: "Repeat for each subsequent milestone until the work is fully complete.",
      warning: "If you have concerns about any milestone, do not release payment. Use the secure chat to communicate with the seller, or open a dispute.",
      receiptMessage: "Your official payment receipt is attached to this email as a PDF.",
    ...
    chatInvite: {
      subject: (invoiceNumber) => `Your Secure Chat Link - Invoice ${invoiceNumber} | Fonlok`,
      ...
      problemBody: "If you did not receive what you ordered, or there is an issue with your order, you can open a dispute. A Fonlok admin will review the case and make a fair decision.",
      chatButton: "Open Chat",
      disputeButton: "Open a Dispute",
      footerNote: "Keep these links private - they are unique to your order. You received this email because a payment was confirmed on Fonlok.",
    },
    payoutConfirmed: {
      subject: (invoiceNumber) => `Payout Confirmed - Invoice ${invoiceNumber} | Fonlok`,
      ...
      receiptMessage: "Your official payout receipt is attached to this email as a PDF. You can also download it at any time using the button below.",
      downloadButton: "Download PDF Receipt",
      ...
      status: "Status",
      paidOut: "Paid Out",
      footer: "Thank you for using Fonlok. This email confirms your payout has been processed. Please keep this receipt for your records.",
    },
    disputeOpened: {
      adminSubject: "URGENT: Dispute Opened — Admin Review Required",
      sellerSubject: (invoiceNumber) => `Dispute Opened — Invoice ${invoiceNumber}`,
      buyerSubject: (invoiceNumber) => `Dispute Opened — Invoice ${invoiceNumber}`,
  ...
  fr: {
    ...
    deliveryNotification: {
      subject: (invoiceName) => `Veuillez confirmer la livraison : ${invoiceName}`,
    ...
    invoicePaid: {
      subject: (invoiceNumber) => `✅ Facture payée — Veuillez livrer | Facture ${invoiceNumber} | Fonlok`,
      ...
      nextStep1: "Livrez le produit ou le service que vous avez convenu avec l'acheteur.",
      nextStep2: "Utilisez le chat pour tenir l'acheteur informé et partager une preuve de livraison.",
      nextStep3: "Une fois que l'acheteur confirme la réception, Fonlok libérera immédiatement vos fonds.",
    ...
    paymentConfirmed: {
      subject: (invoiceNumber) => `Paiement confirmé - Facture ${invoiceNumber} | Fonlok`,
      simpleTitle: "Paiement confirmé",
      simpleBody: "Votre paiement a été reçu avec succès. Vos fonds sont conservés de manière sécurisée en séquestre et ne seront libérés au vendeur qu'une fois que vous aurez confirmé la livraison.",
      ...
      milestoneNote: "Le vendeur travaillera à travers chaque jalon. Une fois qu'un jalon est marqué comme terminé, vous recevrez un <strong>email séparé avec un lien de libération sécurisé en un clic</strong> pour ce seul jalon. Aucun fonds n'est jamais déplacé sans votre confirmation explicite.",
      ...
      step2: "Vous recevez un email avec un lien de libération unique et sécurisé pour ce seul jalon.",
      step3: "Cliquez sur le lien pour vérifier et confirmer &mdash; les fonds ne sont jamais libérés sans votre approbation explicite.",
      step4: "Répétez pour chaque jalon ultérieur jusqu'à ce que le travail soit entièrement terminé.",
      warning: "Si vous avez des préoccupations concernant un jalon, ne libérez pas le paiement. Utilisez le chat sécurisé pour communiquer avec le vendeur ou ouvrez un litige.",
      receiptMessage: "Votre reçu de paiement officiel est joint à cet e-mail en PDF.",
    ...
    chatInvite: {
      subject: (invoiceNumber) => `Votre lien de chat sécurisé - Facture ${invoiceNumber} | Fonlok`,
      ...
      problemBody: "Si vous n'avez pas reçu ce que vous avez commandé ou s'il y a un problème avec votre commande, vous pouvez ouvrir un litige. Un administrateur Fonlok examinera le cas et prendra une décision équitable.",
      chatButton: "Ouvrir le chat",
      disputeButton: "Ouvrir un litige",
      footerNote: "Gardez ces liens privés - ils sont uniques à votre commande. Vous avez reçu cet e-mail parce qu'un paiement a été confirmé sur Fonlok.",
    },
    payoutConfirmed: {
      subject: (invoiceNumber) => `Paiement confirmé - Facture ${invoiceNumber} | Fonlok`,
      ...
      receiptMessage: "Votre reçu de paiement officiel est joint à cet e-mail en PDF. Vous pouvez également le télécharger à tout moment en utilisant le bouton ci-dessous.",
      downloadButton: "Télécharger le reçu en PDF",
      ...
      footer: "Merci d'utiliser Fonlok. Cet e-mail confirme que votre paiement a été traité. Veuillez conserver ce reçu pour vos dossiers.",
    },
    disputeOpened: {
      adminSubject: "URGENT : Litige ouvert — Révision administrative requise",
      sellerSubject: (invoiceNumber) => `Litige ouvert — Facture ${invoiceNumber}`,
      buyerSubject: (invoiceNumber) => `Litige ouvert — Facture ${invoiceNumber}`,
